    ...
    st.markdown(
        ...
        <div class="ts-header">
          ...
          <div class="ts-badges">
            ...
            <div class="ts-badge"><span class="ts-dot" style="background: var(--warning); box-shadow:0 0 0 3px rgba(245,158,11,.14);"></span> Historial exportable</div>
          </div>
        </div>
        """,
...
st.markdown(
    ...
    <div class="ts-header">
      ...
      <div class="ts-sub">Seguimiento en directo + análisis probabilístico. Sin perder datos del historial.</div>
      <div class="ts-badges">
        <div class="ts-badge"><span class="ts-dot"></span> Puntos: {total_pts} · {pct_pts:.0f}%</div>
        ...
        <div class="ts-badge"><span class="ts-dot" style="background: var(--warning); box-shadow:0 0 0 3px rgba(245,158,11,.14);"></span> p(punto): {p_point:.2f}</div>
      </div>
    </div>
    """,
    unsafe_allow_html=True,
...
if st.session_state.page == "LIVE":
    ...
    with st.container(border=True):
        ...
        small_note("Tip: registra el *finish* antes de cada punto para enriquecer el análisis y el resumen del entrenador.")
    ...
    with st.container(border=True):
        ...
        small_note(f"Modelo: p(punto)≈{p_point:.2f} · Win Prob≈{p_match:.1f}% (Markov punto→juego→set→BO3)")
